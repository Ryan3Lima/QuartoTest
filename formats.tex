...
\CommentTok{\#| label: fig{-}limits}
\CommentTok{\#| fig{-}cap: "Errorbar limit selection"}
\ImportTok{import}\NormalTok{ matplotlib.pyplot }\ImportTok{as}\NormalTok{ plt}

\NormalTok{fig }\OperatorTok{=}\NormalTok{ plt.figure()}
\NormalTok{fig.set\_size\_inches(}\DecValTok{10}\NormalTok{,}\DecValTok{6}\NormalTok{)}
...
\includegraphics{formats_files/figure-pdf/cell-2-output-1.png}
